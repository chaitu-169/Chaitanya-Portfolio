...
You can view the live portfolio at: [frontend]
...
```bash
git clone https://github.com/chaitu-169/sriram-portfolio.git
cd portfolio
```
...
If you have any questions or feedback, feel free to contact me via the [contact form](frontend/#contact) on my portfolio website or connect with me through my social profiles (Discord) or you can mail me at sriramchaitu383@gmail.com.
