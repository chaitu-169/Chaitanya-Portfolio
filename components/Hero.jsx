...
const Hero = () => {
  const handleDownloadResume = () => {
    const resumeUrl = "/resume/Sriram_Chaitanya-Resume.pdf";
    ...
    <main className="min-h-[calc(100svh-5.03rem)] md:flex-row flex flex-col-reverse justify-center items-center gap-4">
      ...
      <section className=" max-w-3xl min-h-xl p-4 flex flex-col gap-3 m-4">
        ...
        <p className="lg:text-2xl text-lg text-gray-600">
          ...
          Apps and modern web applications. I work mainly with JavaScript, TypeScript,
          React, Node.js, Express.js, MongoDB,NestJS and learning Flutter.
        </p>

        <p className="lg:text-2xl text-lg text-gray-600">
          I also have a good understanding of Python, React  and use Tailwind CSS to build
